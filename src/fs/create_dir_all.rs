...
///     retty_io::fs::create_dir_all("/some/dir").await.unwrap();
/// });
/// ```
...
impl DirBuilder {
    ...
    ///
    /// ```
    /// let builder = retty_io::fs::DirBuilder::new();
    /// ```
    #[must_use]
    ...
    ///
    /// ```
    /// let mut builder = retty_io::fs::DirBuilder::new();
