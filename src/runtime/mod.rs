...
///
/// This is the Runtime for `retty-io`.
...
///
/// This function must be called from the context of a `retty-io` runtime.
///
...
impl Runtime {
    ...
    ///
    /// This takes the retty-io [`Builder`](crate::Builder) as a parameter.
    ...
    /// Runs a future to completion on the retty-io runtime. This is the
