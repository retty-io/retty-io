...
pub trait ThreadPool {
    /// retty-io runtime will call `schedule_task` on `spawn_blocking`.
...
/// BlockingTask is contrusted by retty-io, ThreadPool impl
...
/// `retty_io::blocking::ThreadPool`. You may use this implementation, or you can use your own thread
/// pool implementation.
