...
async fn echo_server() {
    ...
    retty_io::spawn(async move {
        ...
        for _ in 0..ITER {
            ...
            // writev
            let buf_vec: retty_io::buf::VecBuf = buf_vec_to_write.take().unwrap().into();
            ...
            // readv
            let buf_vec: retty_io::buf::VecBuf =
...
async fn rw_able() {
    ...
    retty_io::select! {
        _ = retty_io::time::sleep(std::time::Duration::from_millis(50)) => {},
